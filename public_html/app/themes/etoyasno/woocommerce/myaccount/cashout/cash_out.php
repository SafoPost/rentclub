                        ...
                        <div class="credit_data">
                            ...
                            <div  class="select_box">
                                ...
                                <? if($personal_data['credit_cards']  && !empty($personal_data['credit_cards'])) :?>
                                     ...
                                     <label for="card_list">Номер карты:    <span class="add_new">+</span></label>
...
jQuery(document).ready(function ($) {
     ...
     if(choose.length >0){
       jQuery('.choose').on('click',function(){
        ...
        jQuery('.select_box').css('display', 'flex');
      ...
      if(add_new.length >0){
       jQuery('.add_new').on('click',function(){
        ...
        jQuery('.input_box').css('display', 'flex');
